...
conditional_statement:
	T_IF '(' boolean_expression ')' {lab1();} T_THEN execution_body {lab2();} if_then_follow
	{
...
;
boolean_expression:
	expression relational_ops  expression {codegen();}
	{
		is_rel_op = 1;
	}
;
...
assignment_ops:
	T_ASOP{push("=");} | T_AS_PE | T_AS_SE | T_AS_MULE | T_AS_DIVE
;
...
relational_ops:
	T_SINGLEEQ{push("=");}|'>'{push(">");}|'<'{push("<");}|T_REL_LE{push("<=");}|T_REL_GE{push(">=");}|T_REL_NE{push("!=");}
;
